...
export const ProductForm = ({title, subtitle, product, onSubmit, saving}:Props) => {
    console.log({product})
    ...
    const removeSize = (sizeToRemove: string) => {
        const sizeSet = new Set(getValues('sizes').filter(item => item != sizeToRemove));
        setValue('sizes',Array.from(sizeSet));
    };
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={cn('w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200', { 'border-red-500 border-3': errors.title })}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200", { 'border-red-500 border-3': errors.price })}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200", { 'border-red-500 border-3': errors.stock })}
                                            placeholder="Stock del producto"
                                        />
                                        {
                                            errors.stock && (
                                                <p className='text-red-500 text-sm'>El stock debe ser mayor a 0</p>
                                            )
                                        }
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        {...register('slug', {required:true, validate:(val) => !/\s/.test(val) || 'El slug no puede contener espacios en blanco' })}
                                        className={cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200", { 'border-red-500 border-3': errors.slug })}
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={5}
                                        className={cn("w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200", { 'border-red-500 border-3': errors.description })}
                            ...
                            <div className="space-y-4">
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {availableSizes.map((size) => (
                                        <span
                                            key={size}
                                            className={cn("inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200", {'hidden': !selectedSizes.includes(size)})}
                                        >
                      {size}
                                            <button
