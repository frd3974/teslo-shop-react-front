        ...
        <div className="container mx-auto px-4 lg:px-8">
            <div className="flex h-16 items-center justify-between">
                ...
                <nav className="hidden md:flex items-center space-x-8">
                    <Link to="/" className={cn(`text-sm font-medium transition-colors hover:text-primary`, gender == undefined ? 'underline underline-offset-4' : '')}>
                        Todos
                    </Link>
                ...
                <div className="flex items-center space-x-4">
                    <div className="hidden md:flex items-center space-x-2">
                        <div className="relative">
                            ...
                            <Input ref={inputRef} onKeyDown={handleSearch} defaultValue={query} placeholder="Buscar productos..." className="pl-9 w-64 h-9 bg-white" />
                        </div>
                    </div>
...

                    {
                        authStatus == 'not-authenticated' ? (
                            ...
                            <Button onClick={logout} variant='outline' size='sm' className='ml-2'>Cerrar sesión</Button>
                        )
                    }
                    {
                        isAdmin() && (
